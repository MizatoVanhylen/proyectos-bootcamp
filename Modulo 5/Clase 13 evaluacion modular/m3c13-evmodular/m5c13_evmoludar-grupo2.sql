...
UPDATE dueño
SET direccion = 'Calle Falsa 987'
WHERE id_dueño = (SELECT id_dueño FROM dueño WHERE nombre = 'Juan Pérez');

-- 5.	Eliminar una atención 
...
-- 1. Se agrega nuevo dueño
INSERT INTO dueño (nombre, direccion, telefono) 
VALUES ('María López', 'Paseo del Mar 456', '555-0011');

-- 2. Se agrega nueva mascota 
INSERT INTO mascota (nombre, tipo, fecha_nacimiento, id_dueño)
VALUES ('Pelusa', 'Gato', '2022-08-15', (SELECT id_dueño 
FROM dueño WHERE nombre = 'María López'));

-- 3. Insertamos la primera atención 
INSERT INTO atencion (fecha_atencion, descripcion, id_mascota, id_profesional)
VALUES (CURRENT_DATE, 'Vacunación inicial', (SELECT id_mascota 
FROM mascota WHERE nombre = 'Pelusa' LIMIT 1), 1);

-- 4. Actualizamos el teléfono del dueño (Juan Pérez)
UPDATE dueño
